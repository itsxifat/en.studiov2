        ...
        <section className="py-20 md:py-32 bg-neutral-900 text-white">
            <div className="container mx-auto px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-neutral-400 mt-4 max-w-2xl mx-auto font-body">Our clients' success is our success.</p>
                </div>
                <div className="relative max-w-3xl mx-auto h-64">
                    <AnimatePresence>
                        <motion.div key={currentIndex} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.5 }} className="absolute inset-0 flex flex-col items-center justify-center text-center">
                            <p className="text-xl md:text-2xl italic text-neutral-200 font-body">"{testimonials[currentIndex].quote}"</p>
                            <div className="mt-6 flex items-center gap-4">
                                <img src={testimonials[currentIndex].photo} alt={testimonials[currentIndex].name} className="w-14 h-14 border-2 border-neutral-700" />
                                <div>
